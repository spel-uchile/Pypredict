...
class Ui_addRemove(object):
    def setupUi(self, addRemove):
        ...
        self.curr_sats_lst = QtWidgets.QListWidget(self.frame_3)
        self.curr_sats_lst.setObjectName("curr_sats_lst")
        self.verticalLayout_3.addWidget(self.curr_sats_lst)
    ...
    def retranslateUi(self, addRemove):
        ...
        self.label_2.setText(_translate("addRemove", "Current satellites:"))
